...
object TwitterConfig {
    ...
    val isDev: Boolean = (EnvConfig["APP_MODE"] ?: "PROD").equals("DEV", ignoreCase = true)
    val callbackUrl: String = EnvConfig["TWITTER_CALLBACK_URL"] 
        ?: if (isDev) "http://localhost:8080/auth/twitter/callback" else "https://kornelian.com/auth/twitter/callback"
